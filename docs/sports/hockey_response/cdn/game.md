...
## https://cdn.espn.com/core/nhl/game?xhr=1&gameId={event}
...
Tested URL:
`https://cdn.espn.com/core/nhl/game?xhr=1&gameId=401871412`

## Example Response

```json
{
  "raw": "<!DOCTYPE HTML PUBLIC \"-//IETF//DTD HTML 2.0//EN\">\n<html><head>\n<title>404 Not Found</title>\n</head><body>\n<h1>Not Found</h1>\n<p>The requested URL /nhl/game/ was not found on this server.</p>\n</body></html>\n"
}
```
